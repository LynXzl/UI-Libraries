...
for i,v in pairs(game.CoreGui:GetChildren()) do
 ...
 local SolarisLib = {
     Themes = {
         ...
         Halloween = {
             ...
             ToggleToggledIcon = Color3.fromRGB(255, 165, 35),
         ...
         Christmas = {
            MainFrame = Color3.fromRGB(30, 30, 30),
             ...
             ToggleToggledIcon = Color3.fromRGB(212, 74, 73),
 ...
 function SolarisLib:New(Config)
     ...
     function SolarisLib:LoadCfg(cfg)
         local success, content = pcall(game:GetService('HttpService').JSONDecode, game:GetService('HttpService'), readfile(cfg))
     ...
     function SolarisLib:SaveCfg(name)
         ...
         writefile(Config.FolderToSave .. "/configs/" .. name .. ".json", tostring(http:JSONEncode(content)))
     end
